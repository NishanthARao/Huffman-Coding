...
entropy_ = 0;   %entropy of the source.
neeta = 0;      %effeciency of the code.
...
for j = 1:i
    entropy_ = entropy_ - pi(j)*(log2(pi(j)));
end

%Compute the effeciency of the code.
neeta = entropy_/L; 
...
%Display the result.
fprintf("The entropy of the source is: %4.2f\n",entropy_);
fprintf("The effeciency of the code is: %4.2f%% \n",neeta*100);
